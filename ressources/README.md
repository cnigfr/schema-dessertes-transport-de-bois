...
|Tableau de travail en commun sur la partie Ponctuel Points d'eau en forêt [GT_Dessertes_Tab_PointsEau.xlsx](https://github.com/cnigfr/schema-dessertes-transport-de-bois/blob/master/ressources/tableaux-de-travail/GT_Dessertes_Tab_PointsEau.xlsx)| 26/11/2025 | Ce tableau a été créé pour l'atelier Points d'eau en forêt de la 1ere réunion du sous-groupe du 27/11/2025. Il recense chacun des éléments ponctuels présents dans Modèle de données AFIGEO pour les PEI. Il contient à côté des propositions d'évolution dans le cadre de la maj du standard. Les commentaires et actions établies durant les ateliers sont reportées sur ce tableau. Il contient le statut de l'attribut (validé, à valider, en discussion, non discuté - explication de la légende dans l'onglet Légende). Il tente d'être exhaustif et de contenir l'ensemble des remarques et décisions prises pour chaque éléments. Il contient enfin une proposition potentielle pour la v2 du standard. |
...
| Titre     | Auteur   | date  |                                  Description                                                              |
| --------- |:--------:|:------:|:--------------------------------------------------------------------------------------------------------:|
| [« Référentiel National pour la DECI du 15/12/2015 »](https://www.interieur.gouv.fr/content/download/91185/709898/file/r%C3%A9f%20nat%20DECI%20du%2015%20d%C3%A9c%202015.pdf)| DGSCGC | 15 décembre 2015 | Ce document est pointé comme référence DECI par le Modèle de données AFIGEO pour les PEI. |
